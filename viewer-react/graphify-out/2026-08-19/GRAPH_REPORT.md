...
## Corpus Check
- 23 files · ~10,113 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 243 nodes · 320 edges · 19 communities (16 shown, 3 thin omitted)
...
Cohesion: 0.11
Nodes (19): ConnectionStatus, describeConnection(), SettingsPanel(), SettingsPanelProps, Connected, connectedStatus, ConnectionChecking, ConnectionError (+11 more)
...
### Community 18 - "CollapsibleSidebar.tsx"
Cohesion: 0.33
Nodes (5): CollapsibleSidebar(), CollapsibleSidebarProps, meta, Story, ToggleHandle
...
- **Why does `react` connect `App.tsx` to `MapContainer.tsx`, `ResultsPanel.stories.tsx`, `SettingsPanel.stories.tsx`, `plugins`, `CollapsibleSidebar.tsx`?**
