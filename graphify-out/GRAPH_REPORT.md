...
## Corpus Check
- 95 files · ~90,092 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 921 nodes · 1204 edges · 69 communities (56 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a54939cb`
...
2. `空域デジタルツインGIS Viewer デザインガイドライン` - 18 edges
3. `compilerOptions` - 18 edges
4. `空域デジタルツイン活用・ドローン航路GIS-PoC 仕様書` - 15 edges
...
### Community 1 - "App.tsx"
Cohesion: 0.17
Nodes (25): ApiResponse, BboxFeatureResult, describeError(), DroneRoute, getBuildingsInBbox(), getConnectionStatus(), getFlightProhibitedAreas(), getGroundFeatures() (+17 more)
...
### Community 65 - "ResultsPanel.stories.tsx"
Cohesion: 0.14
Nodes (13): GroundFeature, PlateauDatasetMeta, datasetMeta, EmptyResult, ErrorState, features, Loading, meta (+5 more)

### Community 66 - "ResultsPanel.tsx"
Cohesion: 0.20
Nodes (8): react, GroundFeatureGroup, QueryResult, GROUP_LABELS, GROUP_ORDER, LAYER_LABELS, ResultsPanel(), ResultsPanelProps

### Community 67 - "MapContainer.stories.tsx"
Cohesion: 0.40
Nodes (4): CollapsibleLegend, LoadingLayers, meta, Story
...
## Knowledge Gaps
- **419 isolated node(s):** `GROUND_FEATURE_LAYERS`, `meta`, `Story`, `CollapsibleLegend`, `LoadingLayers` (+414 more)
...
- **What connects `GROUND_FEATURE_LAYERS`, `meta`, `Story` to the rest of the system?**
